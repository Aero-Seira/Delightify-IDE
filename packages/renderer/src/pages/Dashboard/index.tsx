...
const ResourceCard: React.FC<ResourceCardProps> = ({ icon: Icon, title, description, link, external }) => {
  const content = (
    <>
...
export default function Dashboard(): React.ReactElement {
  ...
  const resources: ResourceCardProps[] = [
    ...
    {
      icon: DocumentIcon,
      title: t('dashboard.resourceDocs'),
      description: t('dashboard.resourceDocsDesc'),
      link: '#',
      external: false,
    },
    {
      icon: BookIcon,
      title: t('dashboard.resourceGuide'),
      description: t('dashboard.resourceGuideDesc'),
      link: '#',
      external: false,
    },
    {
      icon: CommunityIcon,
      title: t('dashboard.resourceCommunity'),
      description: t('dashboard.resourceCommunityDesc'),
      link: '#',
      external: false,
    },
  ];
